<script lang="ts">
	...
	// of, so nothing that adds, removes, reorders or regroups a block is rendered
	// while the override context is set. The drag and drop primitives go with
	// them: the tree is read outside any DragDropProvider there.
