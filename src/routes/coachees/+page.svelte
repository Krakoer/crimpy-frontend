		...
		{#if showEnrollmentPanel}
			...
			>
				...
				{:else if generatingToken}
					<div style="font-size: 12.5px; color: var(--tx3-sm);">Generating...</div>
		...
		>
			<div
				style="
					...
					font-size: 11px; color: var(--tx3-sm); font-weight: 600;
			...
			{#if loading}
				<div
					style="display: flex; align-items: center; gap: 12px; padding: 24px 20px; color: var(--tx3-sm); font-size: 13px;"
				>
					<div
			...
			{:else if filtered.length === 0}
				<div
					style="padding: 32px 20px; text-align: center; color: var(--tx3-sm); font-size: 13.5px;"
				>
