...
>
				...
				{#if confirmDelete}
					...
					<button
						...
						style="
							...
							padding: 8px 14px; border-radius: var(--rs);
							background: #fff; color: var(--tx3-sm); border: 1px solid var(--bd);
							font-size: 13px; font-weight: 600; cursor: pointer; font-family: var(--font);
						">Cancel</button
					>
				{:else}
	...
	{#if loading}
		<div
			style="padding: 40px; display: flex; align-items: center; gap: 10px; color: var(--tx3-sm);"
		>
			<div
	...
	{:else if !isEditing}
		<div style="padding: 20px 28px 40px;">
			...
			>
				...
				{/if}
				{#if draft.goal}
					<p style="font-size: 12px; color: var(--tx3-sm);">
